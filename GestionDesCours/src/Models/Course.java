...
public class Course 
{
    ...
    public Course(String title, String subject, CourseType type, int teacherNcin, String courseFilePath, LocalDateTime deadline) 
    {
        this.title = title;
    ...
    public Course(int id, String title, String subject, CourseType type, int teacherNcin, String courseFilePath, LocalDateTime deadline, LocalDateTime createdAt) 
    {
        this.id = id;
        this.title = title;
        this.subject = subject;
